        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(
                        ...
                        args: [message(code: 'country.label', default: 'Country'), country.id]
                )
                redirect country
            }
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(
                        ...
                        args: [message(code: 'country.label', default: 'Country'), id]
                )
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(
                        ...
                        args: [message(code: 'country.label', default: 'Country'), params.id]
                )
                redirect action: "index", method: "GET"
            }
