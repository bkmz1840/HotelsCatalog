        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(
                        ...
                        args: [message(code: 'hotel.label', default: 'Hotel'), hotel.id]
                )
                redirect hotel
            }
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(
                        ...
                        args: [message(code: 'hotel.label', default: 'Hotel'), id]
                )
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(
                        ...
                        args: [message(code: 'hotel.label', default: 'Hotel'), params.id]
                )
                redirect action: "index", method: "GET"
            }
